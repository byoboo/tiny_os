//! Soft IRQ Management for Deferred Processing
//!
//! This module implements the soft IRQ mechanism for deferring interrupt
//! processing to improve system responsiveness.

use super::{deferred_stats::SoftIrqStats, work_item::WorkFunction, work_queue::WorkQueue};
