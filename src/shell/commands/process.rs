...
pub fn handle_process_context_test(context: &ShellContext) {
    ...
    context.uart.puts("1. Testing Process Context Creation...\r\n");
    ...
    context.uart.puts("   ✓ Process context created successfully\r\n");
    ...
    let mut test_context = process::context::ProcessContext::new(2, 0x4000_0000, 0x5000_0000, 0x6000_0000);
...
pub fn handle_privilege_test(context: &ShellContext) {
    ...
    context.uart.puts("1. Testing Current Privilege Level...\r\n");
    ...
    let validation_result = process::privilege::validate_privilege(process::privilege::PrivilegeLevel::EL1);
...
pub fn handle_scheduler_test(context: &ShellContext) {
    ...
    context.uart.puts("1. Testing Scheduler Initialization...\r\n");
    ...
    context.uart.puts("   (High priority task should be scheduled first)\r\n");
...
pub fn handle_scheduler_stats(context: &ShellContext) {
    ...
    context.uart.put_hex(process::scheduler::get_task_count() as u64);
    context.uart.puts("\r\n");
