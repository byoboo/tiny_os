...
// automated testing pub use control::{cmd_mmu_control, cmd_mmu_enable_disable};
// pub use stats::{cmd_exception_stats, cmd_mmu_stats,
// cmd_reset_exception_stats}; pub use status::cmd_virtual_memory_status;
