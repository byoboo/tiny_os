...
use crate::{apps::editor::TextEditor, shell::ShellContext};
...
pub fn cmd_edit(args: &[&str], context: &mut ShellContext) {
    ...
    context
        .uart
        .puts("  Ctrl+X  - Force quit (without saving)\n");
...
fn show_editor_help(context: &mut ShellContext) {
    ...
    context
        .uart
        .puts("  edit [filename]     - Open editor with optional file\n");
    context
        .uart
        .puts("  editor [filename]   - Alias for edit command\n");
    context
        .uart
        .puts("  edit help           - Show this help\n\n");

    context.uart.puts("Editor Features:\n");
    context
        .uart
        .puts("  • Text editing with cursor navigation\n");
    ...
    context
        .uart
        .puts("  Ctrl+D  - Delete character under cursor\n");
    ...
    context
        .uart
        .puts("  Backspace - Delete previous character\n");
    ...
    context
        .uart
        .puts("  • Automatically detects file existence\n");
    ...
    context
        .uart
        .puts("  edit hello.txt      - Open hello.txt\n");
    context
        .uart
        .puts("  edit readme.md      - Open readme.md\n");
    context
        .uart
        .puts("  editor config.txt   - Open config.txt\n\n");
}

// Removed unused quick_edit and benchmark commands for streamlined
// implementation
