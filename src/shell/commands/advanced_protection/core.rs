...
pub fn cmd_advanced_protection(args: &[&str], context: &mut ShellContext) {
    ...
    match args[0] {
        "status" => super::status::cmd_advanced_protection_status(args, context),
        "permissions" => super::permissions::cmd_advanced_protection_permissions(args, context),
        "aslr" => super::aslr::cmd_advanced_protection_aslr(args, context),
        "stack" => super::stack::cmd_advanced_protection_stack(args, context),
        "test" => super::testing::cmd_advanced_protection_test(args, context),
        "stats" => super::stats::cmd_advanced_protection_stats(args, context),
