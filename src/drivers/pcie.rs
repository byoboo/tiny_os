...
use crate::{benchmarks::timing::get_cycles, drivers::dma::get_dma_controller};
...
impl PcieController {
        ...
        unsafe {
            ...
            for _ in 0..10000 {
                let status = read_volatile(
                    (self.base_addr + pcie_registers::PCIE_MISC_PCIE_STATUS) as *const u32,
                );
    ...
    fn probe_device(
        ...
        device: u8,
        function: u8,
    ) -> Result<Option<PcieDevice>, PcieError> {
