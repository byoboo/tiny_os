...
//! Optimized for Pi 4/5 enhanced DMA capabilities while maintaining Pi 3 compatibility.
...
impl DmaControlBlock {
    ...
    pub fn new_optimized_transfer(src: u32, dst: u32, length: u32, is_pi4_or_5: bool) -> Self {
        ...
        if is_pi4_or_5 {
            ...
            // Enable wider transfers for better bandwidth utilization
        } else {
...
impl DmaChannel {
    ...
    pub fn memory_transfer(&self, src: *const u8, dst: *mut u8, length: u32, is_pi4_or_5: bool) -> Result<u64, &'static str> {
        ...
        let control_block = DmaControlBlock::new_optimized_transfer(src_bus, dst_bus, length, is_pi4_or_5);
...
impl DmaController {
    ...
    pub const fn new() -> Self {
        Self {
            channels: [
                DmaChannel::new(0), DmaChannel::new(1), DmaChannel::new(2), DmaChannel::new(3),
                DmaChannel::new(4), DmaChannel::new(5), DmaChannel::new(6), DmaChannel::new(7),
                DmaChannel::new(8), DmaChannel::new(9), DmaChannel::new(10), DmaChannel::new(11),
                DmaChannel::new(12), DmaChannel::new(13), DmaChannel::new(14),
            ],
            is_pi4_or_5: false,
            initialized: false,
        }
    ...
    pub fn benchmark_memory_copy(&self, size: usize) -> Result<(u64, u64), &'static str> {
        ...
        // CPU copy
        let cpu_cycles = self.cpu_memory_copy(&mut dst_cpu[..actual_size], &src_data[..actual_size]);
...
pub fn init(is_pi4_or_5: bool) -> Result<(), &'static str> {
    unsafe {
        DMA_CONTROLLER.init(is_pi4_or_5)
    }
}
